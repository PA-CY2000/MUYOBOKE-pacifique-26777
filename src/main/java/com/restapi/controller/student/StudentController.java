...
public class StudentController {
    ...
    public StudentController() {
        ...
        students.add(new Student(26779L, "Gabriel", "Rubayiza", "gabriel.rubayiza@email.com", "Business", 3.2));
        students.add(new Student(26780L, "Umutoni", "Wase", "umutoni.wase@email.com", "Engineering", 3.9));
        students.add(new Student(26781L, "Rukundo", "Bruno", "rukundo.bruno@email.com", "Computer Science", 3.4));
    }
